...
def test_subdivide_triangles_iterations_0():
    ...
    assert np.allclose([[1., 0., 1.]], added_points)
...
def test_subdivide_triangles_iterations_1():
    ...
    expected_points = np.array([[3., 0., 3.],
                                [1., 0., 4.],
                                [4., 0., 4.],
                                [4., 0., 1.]])
    expected_triangles = np.array([[0, 4, 3],
                                   [3, 4, 1],
                                   [1, 4, 0],
                                   [1, 5, 3],
                                   [3, 5, 2],
...
def test_subdivide_triangles_by_total_area_2():
    ...
    expected_points = np.array([
       ...
       [4.        , 0.        , 4.        ],
       [4.        , 0.        , 1.        ],
       [1.33333333, 0.        , 2.33333333],
       [1.33333333, 0.        , 5.33333333],
       [0.33333333, 0.        , 4.33333333],
       [2.33333333, 0.        , 5.33333333],
       [5.33333333, 0.        , 2.33333333],
       [4.33333333, 0.        , 4.33333333],
       [5.33333333, 0.        , 1.33333333],
       [2.33333333, 0.        , 1.33333333],
       [4.33333333, 0.        , 0.33333333],
       [2.66666667, 0.        , 2.66666667],
       [0.88888889, 0.        , 3.55555556],
       [3.55555556, 0.        , 3.55555556],
       [3.55555556, 0.        , 0.88888889],
       [1.18518519, 0.        , 2.07407407],
       [1.18518519, 0.        , 4.74074074],
       [0.2962963 , 0.        , 3.85185185],
       [2.07407407, 0.        , 4.74074074],
       [4.74074074, 0.        , 2.07407407],
       [3.85185185, 0.        , 3.85185185],
       [4.74074074, 0.        , 1.18518519]]) 
