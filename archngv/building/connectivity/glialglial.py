...
def generate_glialglial(touches_directory):
    ...
    props['efferent_section_type'], props['afferent_section_type'] = _unpack_types(props['branch_type'])

    # TouchDetector uses an enumeration that starts from 0 for the soma, reducing all the swc types by one
